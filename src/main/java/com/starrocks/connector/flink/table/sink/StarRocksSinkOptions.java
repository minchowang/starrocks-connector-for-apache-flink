...
public class StarRocksSinkOptions implements Serializable {
    ...
    public static final ConfigOption<Integer> SINK_FlUSH_THREAD = ConfigOptions.key("sink.flush-thread")
            .intType().defaultValue(32).withDescription("Flush thread num for waiting write queue.");
    ...
    public int getSinkFlushThread() {
        return tableOptions.get(SINK_FlUSH_THREAD);
    }
